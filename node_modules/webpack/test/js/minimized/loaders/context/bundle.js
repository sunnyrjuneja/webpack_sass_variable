...
function(t,e,r){it("should be able to use a context with a loader",function(){var t="abc",e="script.coffee";r(/*! ../_resources */1)("./"+e).should.be.eql("coffee test"),r(/*! raw!../_resources */3)("./"+t+".txt").should.be.eql("abc")})},/*!*************************************!*\
  !*** ./loaders/_resources ^\.\/.*$ ***!
  \*************************************/
function(t,e,r){function n(t){return r(o(t))}function o(t){return i[t]||function(){throw new Error("Cannot find module '"+t+"'.")}()}var i={"./abc.txt":2,"./included.jade":6,"./parent.jade":7,"./script.coffee":5,"./template.jade":8};n.keys=function(){return Object.keys(i)},n.resolve=o,t.exports=n},/*!************************************!*\
...
function(t,e,r){r(/*! (webpack)/~/jade/lib/runtime.js */11);t.exports=function(){var t=[];return t.push("<h1>included</h1>"),t.join("")}},/*!****************************************!*\
  ...
  \****************************************/
function(t,e,r){r(/*! (webpack)/~/jade/lib/runtime.js */11);t.exports=function(t){var e,n=[];/*! ./loaders/_resources/included.jade */return n.push("<p></p>"+(null==(e=r(6).call(this,t))?"":e)),n.join("")}},/*!******************************************!*\
  !*** ./loaders/_resources/template.jade ***!
  \******************************************/
function(t,e,r){var n=r(/*! (webpack)/~/jade/lib/runtime.js */11);t.exports=function(t){var e,o=[],i=t||{},s=i.abc,a=i.self;/*! ./loaders/_resources/included.jade */return o.push("<p>"+n.escape(null==(e="undefined"==typeof s?"self"+a.abc:s)?"":e)+"</p>"+(null==(e=r(6).call(this,t))?"":e)),o.join("")}},,,/*!***************************************!*\
